...
12-team full-PPR auction ($250 per Sleeper draft settings; code falls back to $200 when unset), Sleeper `1397736035240173568`. Roster `['QB','RB','RB','WR','WR','TE','FLEX','FLEX','K','DEF','BN','BN','BN','BN']` + `reserve_slots=2` IR (not in `roster_positions`). 2 extra FLEX → receiving volume premium at RB/WR/TE.
