...
def _apply_migrations(conn: sqlite3.Connection) -> None:
    ...
    if cur_version < 11:
        # Rest-of-season projections v11 — per-player aggregate of remaining
        # weeks' neutral per-game projections. Populated during refresh from
        # the model's _neutral_points field. Additive only, safe to re-run.
        conn.execute(
